document.getElementById("Concatenate").onclick=function(){
    ...
    let num2 = "24"
    let sum = num1 + num2 ;
    document.getElementById("Statement").innerHTML='"20" + "24" '
 ...
 document.getElementById("ifnested").onclick=function(){
     ...
     if(userName==="Rameez"){
         ...
         document.getElementById("output").innerHTML="Wrong userNAme <br> Correct user name is Rameez"
     }
 }
 ...
 document.getElementById("login").onclick = function(){
     let Username = prompt("Enter Your username ")
     let Password = prompt("Enter your password")
     if(Username ==="Rameezkhan"){
         if(Password==="344402"){
             document.getElementById("output").innerHTML="You are successfully logged in"
             
         }
         else{
             document.getElementById("output").innerHTML="incorrect password or username <br>Rameezkhan use  as username or 344402 as password "
         }
     }
     else{
